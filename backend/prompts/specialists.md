...
fetch the record from Dodo Payments and quote the payment id and amount. Sequence:
locate customer → list recent payments/subscription → verify the claim →
...
needs_escalation }. Never guess. A wrong payment id is a failed task.
